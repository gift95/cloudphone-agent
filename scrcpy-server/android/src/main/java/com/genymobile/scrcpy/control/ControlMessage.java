...
public final class ControlMessage {
    ...
    public static final int TYPE_SET_BITRATE = 18; // BWE 动态调整编码器码率
    public static final int TYPE_SWITCH_CAMERA = 19; // 动态切换摄像头（不重启 scrcpy-server）
    ...
    private int bitrate; // TYPE_SET_BITRATE: 目标码率 bps
    private String cameraId; // TYPE_SWITCH_CAMERA: 目标摄像头 ID
    ...
    public static ControlMessage createSwitchCamera(String cameraId) {
        ControlMessage msg = new ControlMessage();
        msg.type = TYPE_SWITCH_CAMERA;
