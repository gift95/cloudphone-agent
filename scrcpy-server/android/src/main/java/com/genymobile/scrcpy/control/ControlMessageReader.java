...
public class ControlMessageReader {
    ...
    private ControlMessage parseSwitchCamera() throws IOException {
        String cameraId = parseString();
        return ControlMessage.createSwitchCamera(cameraId);
    }
