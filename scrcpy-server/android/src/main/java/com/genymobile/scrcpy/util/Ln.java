...
public final class Ln {
    ...
    public static void v(String message) {
        if (isEnabled(Level.VERBOSE)) {
            Log.v(TAG, message);
            CONSOLE_OUT.print(PREFIX + "[" + getTimestamp() + "] VERBOSE: " + message + '\n');
        }
    }
    ...
    public static void d(String message) {
        if (isEnabled(Level.DEBUG)) {
            Log.d(TAG, message);
            CONSOLE_OUT.print(PREFIX + "[" + getTimestamp() + "] DEBUG: " + message + '\n');
        }
    }
    ...
    public static void i(String message) {
        if (isEnabled(Level.INFO)) {
            Log.i(TAG, message);
            CONSOLE_OUT.print(PREFIX + "[" + getTimestamp() + "] INFO: " + message + '\n');
        }
    }
    ...
    public static void w(String message, Throwable throwable) {
        if (isEnabled(Level.WARN)) {
            ...
            synchronized (CONSOLE_ERR) {
                CONSOLE_ERR.print(PREFIX + "[" + getTimestamp() + "] WARN: " + message + '\n');
                if (throwable != null) {
    ...
    public static void e(String message, Throwable throwable) {
        if (isEnabled(Level.ERROR)) {
            ...
            synchronized (CONSOLE_ERR) {
                CONSOLE_ERR.print(PREFIX + "[" + getTimestamp() + "] ERROR: " + message + '\n');
                if (throwable != null) {
                    throwable.printStackTrace(CONSOLE_ERR);
                }
            }
